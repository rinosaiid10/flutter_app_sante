                  ...
                  child: SingleChildScrollView(
                    ...
                    child: DataTable(
                      columns: [
                        ...
                        DataColumn(
                          label: Text('Heure',textAlign: TextAlign.center,textScaleFactor: 1,style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                        ),
                        DataColumn(
                          label: Text('Nom et Prenoms',textAlign: TextAlign.center,textScaleFactor: 1,style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                        ),
                        DataColumn(
                        ...
                        DataColumn(
                          label: Text('Docteur / Spécialité',textAlign: TextAlign.center,textScaleFactor: 1,style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                        ),
                        DataColumn(
                          label: Text('Motif',textAlign: TextAlign.center,textScaleFactor: 1,style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                        ),
