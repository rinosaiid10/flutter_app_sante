...
class SortirProduit extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return  _SortirProduit();
  }


}

class _SortirProduit extends State<SortirProduit>{
  ...
  List<String>lProduit=new List<String>();
    ...
    return new Scaffold(
      ...
      body:Container(
        ...
        child: ListView(
          ...
          children: [
            SizedBox(height: 20,),
            Text("Sortir Produits",textAlign: TextAlign.center,textScaleFactor: 1.8,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.deepOrange),),
            SizedBox(height: 40,),
            Wrap(
              children: [
                ListCombo<String>(
