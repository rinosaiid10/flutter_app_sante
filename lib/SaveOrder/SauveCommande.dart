...
class SauveCommande extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return  _SauveCommande();
  }


}

class _SauveCommande extends State<SauveCommande>{
    ...
    return new Scaffold(
      ...
      body:Container(
        ...
        child: ListView(
          ...
          children: [
            SizedBox(height: 20,),
            Text("Save Commande",textAlign: TextAlign.center,textScaleFactor: 1.8,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.deepOrange),),
            SizedBox(height: 40,),
            Wrap(
              children: [
                TextFormField(
