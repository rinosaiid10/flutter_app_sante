...
class ajoutDocteur extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return  _ajoutDocteur();
  }


}

class _ajoutDocteur extends State<ajoutDocteur>{
    ...
    return new Scaffold(
      ...
      body:Container(
        ...
        child: ListView(
          ...
          children: [
            SizedBox(height: 20,),
              Text("Ajouter Docteur",textAlign: TextAlign.center,textScaleFactor: 1.8,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.deepOrange),),
            SizedBox(height: 40,),
            Wrap(
              children: [
                TextFormField(
            ...
            GestureDetector(
                onTap: (){
                  ImagePickerGC.pickImage(context: context, source: ImgSource.Both,maxHeight:40,maxWidth:40).then((value){
                    if(value!=null){
