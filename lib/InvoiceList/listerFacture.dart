...
class listeFacture extends StatefulWidget {
  @override
  _listeFactureState createState() => _listeFactureState();
}

class _listeFactureState extends State<listeFacture> {
  @override
              ...
              child: SingleChildScrollView(
                ...
                child: DataTable(
                  columns: [
                    ...
                    DataColumn(
                      label: Text('Produit',textAlign: TextAlign.center,textScaleFactor: 1,style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                    ),
                    DataColumn(
                      label: Text('Quantité',textAlign: TextAlign.center,textScaleFactor: 1,style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                    ),
                    // DataColumn(
                    //   label: Text('Quantité',textAlign: TextAlign.center,textScaleFactor: 1,style: TextStyle(color: Colors.black87,fontWeight: FontWeight.bold),),
                    // ),
