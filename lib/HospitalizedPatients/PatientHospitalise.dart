...
class PatientHospitalise extends StatefulWidget {
  @override
  _PatientHospitaliseState createState() => _PatientHospitaliseState();
}

class _PatientHospitaliseState extends State<PatientHospitalise> {
  @override
