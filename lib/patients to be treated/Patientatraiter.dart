...
class PatientTraiter extends StatefulWidget {
  @override
  _PatientTraiterState createState() => _PatientTraiterState();
}

class _PatientTraiterState extends State<PatientTraiter> {
  @override
